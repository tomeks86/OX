...
import edu.tseidler.model.Choice;
...
public class WinnerValidatorTest {
    ...
    public void boardSetUp() {
        ...
        IntStream.of(1, 3, 5, 13).forEach(i -> board.put(new Choice(i), BoardField.O));
    }
    ...
    public void shouldBeNoWinner(int position) {
        board.put(new Choice(position), BoardField.O);
    ...
    public void shouldFindWinnerOnHorizontal() {
        board.put(new Choice(2), BoardField.O);
    ...
    public void shouldFindWinnerOnVertical() {
        board.put(new Choice(8), BoardField.O);
    ...
    private void shouldFindWinnerOnDiagonal() {
        board.put(new Choice(7), BoardField.O);
    ...
    private void shouldFindWinnerOnAntiDiagonal() {
        board.put(new Choice(9), BoardField.O);
